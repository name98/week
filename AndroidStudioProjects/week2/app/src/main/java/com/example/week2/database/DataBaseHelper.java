...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public void insert(NoteItem note) {
    ...
    public boolean isAdded(int key) {
        SQLiteDatabase db = this.getReadableDatabase();
        @SuppressLint("Recycle") Cursor cursor = db.rawQuery("Select " + PRIMARY_KEY +
                " from " + TABLE_NAME + " where " + PRIMARY_KEY + "=" + key + ";", null);
    ...
    public ArrayList<NoteItem> getSortedNotes() {
        ArrayList<NoteItem> significanceNotes = getPinedNotes();
        ArrayList<NoteItem> unSignificanceNotes = getUnPinedNotes();
        ArrayList<NoteItem> notes = new ArrayList<>();
